...
public class OI {
  ...
  // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    ...
    public JoystickButton masterDeadmanSwitch;
  ...
  public OI() {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        masterGamePad = new Joystick(1);
        
        masterDeadmanSwitch = new JoystickButton(masterGamePad, 1);
        masterDeadmanSwitch.whileHeld(new DriveTeleop());
