...
public class OI {
    ...
    public OI() {
        ...
        buttonA = new JoystickButton(joystick1, 1);
        buttonA.whileHeld(new DriveBackward1Second());
        buttonX = new JoystickButton(joystick1, 3);
        buttonX.whileHeld(new LiftDown());
        buttonB = new JoystickButton(joystick1, 2);
        buttonB.whileHeld(new LiftUp());
        buttonY = new JoystickButton(joystick1, 4);
        buttonY.whileHeld(new DriveForward1Second());
